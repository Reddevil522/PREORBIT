...
JavaDSAQuestionSchema.index({ chapterSlug: 1 });
JavaDSAQuestionSchema.index({ testId: 1 });
JavaDSAQuestionSchema.index({ chapterSlug: 1, testId: 1 });

module.exports = mongoose.models.JavaDSAQuestion || mongoose.model('JavaDSAQuestion', JavaDSAQuestionSchema);
